...
"""Tests for the VLM REST API entry point (rest_api.py).

This test depends on //services/vlm:rest_api which has //utils:git_sha
...
from services.vlm.rest_api import app

...
"""Unit tests for vlm/settings.py."""
...
from services.vlm.settings import Settings, get_settings


class TestSettings(unittest.TestCase):
    """Tests for the VLM Settings class."""
...
class TestStorageCredentialsFromEnv(unittest.TestCase):
    ...
    def test_all_storage_credentials_from_env(self) -> None:
        """Test all storage credentials can be loaded from AWS_* env vars (backward compat)."""
        env_vars = {
